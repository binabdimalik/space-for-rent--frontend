                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                {bookings.map(booking => (
                                    <div key={booking.id} style={{ 
                                        ...
                                        <div>
                                            <h3 style={{ fontWeight: 700, color: '#1e3a8a', marginBottom: '8px' }}>
                                                {booking.space_title}
                                            </h3>
                                            <div style={{ display: 'flex', gap: '16px', color: '#6a7282', fontSize: '14px' }}>
                                        ...
                                        <div style={{ textAlign: 'right' }}>
                                            <div style={{ fontWeight: 700, fontSize: '20px', color: '#2563eb', marginBottom: '8px' }}>
