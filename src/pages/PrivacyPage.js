            ...
            <div style={{ 
                ...
                <div style={{ 
                    ...
                    <p style={{ 
                        ...
                        At SpaceHub, we are committed to protecting your privacy and ensuring the security of your personal information. 
                        This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our 
                        platform. By using SpaceHub, you agree to the collection and use of information in accordance with this policy.
                    </p>
                </div>
                        ...
                        <ul style={{ 
                            ...
                            {section.content.map((item, itemIndex) => (
                                <li key={itemIndex} style={{ 
                                    padding: '12px 0',
                                    borderBottom: itemIndex < section.content.length - 1 ? '1px solid #f3f4f6' : 'none',
                                    color: '#4a5565',
                                    lineHeight: 1.7
                                }}>
                                    {formatContent(item)}
                ...
                <div style={{ 
                    ...
                    <p style={{ color: '#4a5565', lineHeight: 1.8, marginBottom: '16px' }}>
                ...
                <div style={{ 
                    ...
                    <p style={{ color: '#4a5565', lineHeight: 1.8, marginBottom: '16px' }}>
                        ...
                        perform service-related functions, or assist us in analyzing how our service is used. These third parties have 
                        access to your personal data only to perform these tasks on our behalf and are obligated not to disclose or use 
                        it for any other purpose.
                    </p>
                    <p style={{ color: '#4a5565', lineHeight: 1.8 }}>
                        Our partners include payment processors, analytics providers, and cloud hosting services. We ensure all partners 
                        meet our strict privacy and security standards.
                    </p>
                </div>
