...
import { FiHome, FiGrid, FiUsers, FiCalendar, FiDollarSign, FiPlus, FiEdit2, FiTrash2, FiMessageCircle } from 'react-icons/fi';
            ...
            <main className="admin-content">
                ...
                <div className="admin-table">
                    <div style={{ padding: '16px 24px', borderBottom: '1px solid #e5e7eb', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <h2 style={{ fontWeight: 600, fontSize: '16px', color: '#1e3a8a' }}>Recent Spaces</h2>
                        <Link to="/admin/spaces" style={{ color: '#2563eb', fontSize: '14px', textDecoration: 'none' }}>View All</Link>
                    </div>
                    <table>
                        <thead>
                            <tr>
