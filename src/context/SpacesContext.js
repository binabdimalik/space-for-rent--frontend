...
const initialSpaces = [
  {
    ...
    title: "Modern Meeting Room", // Display name for the space
    description:
      "A sleek, professional meeting room with state-of-the-art technology. Perfect for business meetings, presentations, and workshops.",
    location: "123 Main St, NYC", // Physical address
    price_per_hour: 50, // Hourly rental rate in dollars
    price_per_night: 400, // Daily rental rate (8 hours)
    capacity: 10, // Maximum number of people
    status: "available", // Availability: 'available' or 'rented'
    latitude: 40.7128, // GPS latitude for map marker
    longitude: -74.006, // GPS longitude for map marker
    image_url:
      "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=800", // Space photo
    amenities: "WiFi, Projector, Whiteboard, Coffee Machine", // Available facilities
  },
  {
    id: 2,
    title: "Creative Loft Space",
    description:
      "An inspiring open loft with natural light and creative atmosphere. Ideal for photo shoots, workshops, and creative events.",
    location: "456 Art Ave, Los Angeles",
    price_per_hour: 80,
    price_per_night: 640,
    capacity: 20,
  ...
  },
  {
    ...
    title: "Cozy Event Studio",
    description:
      "A warm and inviting studio space perfect for intimate events, classes, and small gatherings.",
    location: "789 Beach Rd, Miami",
    price_per_hour: 100,
    price_per_night: 800,
    capacity: 50, // Larger capacity for events
  ...
  },
  {
    ...
    title: "Bright Work Lounge",
    description:
      "A comfortable co-working space with plenty of natural light and modern amenities for productive work sessions.",
    location: "321 Lake St, Chicago",
    price_per_hour: 40, // More affordable option
    price_per_night: 320,
    capacity: 15,
...
=======
  ...
  const updateSpace = (id, spaceData) => {
    ...
    setSpaces((prev) =>
      prev.map(
        (s) => (s.id === id ? { ...s, ...spaceData } : s), // Merge updates with existing data
      ),
    );
  };
